    ...
    return (
        <div style={{
            ...
            <div className="text-center">
                ...
                <button className='bg-btn-yellow text-dark-02 font-bold py-3 px-4 rounded-xl hover:bg-lime-500  shadow-lg ring-1 ring-offset-4 ring-btn-yellow dark:ring-offset-slate-900'>Claim Free Credit</button>
            </div>
        </div>
    );
};
